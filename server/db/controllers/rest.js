...
export default class REST {
  ...
  ***** */
  ...
  /* *****
  AUTH: Require tmobileids for certain routes (POST/PATCH/DELETE)
  ***** */
  requiretmobileid (req, res, next, loginUrl = '/login') {
    if (env === 'production') {
  ...
  logUserAction (req, res, next, name, protocol) {
    Log.userAction(
      _.get(req, 'session.passport.user.tmobileid', 'Anonymous'),
      protocol,
